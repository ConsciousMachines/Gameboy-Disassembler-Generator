...
// TODO: find max possible length of instr text
...
dis_line disassemble_cb(u16 pc, u8 b2)
{
	switch (b2)
	{
...
dis_line disassemble(u8* bytes, u16 pc, long size)
{
	...
	case 0x18: {dis_line l = dis_line{ pc, 2, {b1,b2,b3},"" }; sprintf(l._text, "JR $%02x [%hhi]\n", b2, b2); return l; }
	...
	case 0x20: {dis_line l = dis_line{ pc, 2, {b1,b2,b3},"" }; sprintf(l._text, "JR NZ,$%02x [%hhi]\n", b2, b2); return l; }
	...
	case 0x28: {dis_line l = dis_line{ pc, 2, {b1,b2,b3},"" }; sprintf(l._text, "JR Z,$%02x [%hhi]\n", b2, b2); return l; }
	...
	case 0x30: {dis_line l = dis_line{ pc, 2, {b1,b2,b3},"" }; sprintf(l._text, "JR NC,$%02x [%hhi]\n", b2, b2); return l; }
	...
	case 0x38: {dis_line l = dis_line{ pc, 2, {b1,b2,b3},"" }; sprintf(l._text, "JR C,$%02x [%hhi]\n", b2, b2); return l; }
	...
	case 0xCB: return dis_line{ pc, 1, {b1,b2,b3},"PREFIX CB\n" };
	...
	case 0xE8: {dis_line l = dis_line{ pc, 2, {b1,b2,b3},"" }; sprintf(l._text, "ADD SP,$%02x [%hhi]\n", b2, b2); return l; }
	...
	case 0xF8: {dis_line l = dis_line{ pc, 2, {b1,b2,b3},"" }; sprintf(l._text, "LD HL,SP+$%02x [%hhi]\n", b2, b2); return l; }
